 ...
 <button id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-gray-700 border border-gray-300 rounded-lg hover:text-white hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:border-gray-500 dark:text-gray-500 dark:hover:text-white dark:hover:bg-gray-500 dark:focus:ring-gray-800 me-2 mb-2" type="button">
    ...
    <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    ...
                    <ul class="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownSearchButton">
                        @foreach($ouvriersListes as $ouvrier)
                            <li>
                               ...
                               @endif
                                    <input checked id="checkbox-item-{{ $ouvrier->id }}" type="checkbox" wire:model="ouvriers" value="{{old('ouvrier',$ouvrier->id )}}" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:bg-gray-700 dark:border-gray-600">
       ...
       <div class="w-full mb-5 group flex flex-row">
            ...
            <div class="w-1/4">
                <x-radio id="rounded-lg" wire:model="statut" value="{{old('statut',$projet->statut)}}"  rounded="lg" label="Initial" value="initial" xl />
            </div>
            <div class="w-1/4">
                <x-radio id="rounded-lg" wire:model="statut" value="{{old('statut',$projet->statut)}}" rounded="lg" label="En cours" value="en_cours" xl />
            </div>
            <div class="w-1/4">
                <x-radio id="rounded-lg" wire:model="statut" value="{{old('statut',$projet->statut)}}"  rounded="lg" label="Terminé" value="terminer" xl />
            </div>
       ...
       <div>
        ...
        <div class="flex justify-end">
            <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">  Enregistrer</button>
        </div>
    </form>
</div>