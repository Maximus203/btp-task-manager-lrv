...
return [
    ...
    */
    ...
    'ascii' => 'Le champ :attribute doit seulement contenir des caractères alphanumériques et des symboles en octets simples.',
    ...
    | les lignes. Cela rend rapide la spécification d'une ligne de langue
    | personnalisée spécifique pour une règle d'attribut.
    |
    */
    ...
    | espace réservé d'attribut par quelque chose de plus convivial pour
    | le lecteur, comme "Adresse E-Mail" à la place de "email". Cela nous
    | aide simplement à rendre notre message plus expressif.
    |
    */
